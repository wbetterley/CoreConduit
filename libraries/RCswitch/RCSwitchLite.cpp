...
// #endif
unsigned int RCSwitchLite::timings[RCSWITCH_MAX_CHANGES];

RCSwitchLite::RCSwitchLite() {
...
/**
  ...
  */
void RCSwitchLite::setProtocol(int nProtocol) {
...
/**
  ...
  */
void RCSwitchLite::setProtocol(int nProtocol, int nPulseLength) {
  this->nProtocol = nProtocol;
...
/**
  ...
  */
void RCSwitchLite::setPulseLength(int nPulseLength) {
 ...
 */
void RCSwitchLite::setRepeatTransmit(int nRepeatTransmit) {
 ...
 */
void RCSwitchLite::enableTransmit(int nTransmitterPin) {
...
/**
  ...
  */
void RCSwitchLite::disableTransmit() {
  this->nTransmitterPin = -1;
}
...
void RCSwitchLite::send(unsigned long Code, unsigned int length) {
  this->send( this->dec2binWzerofill(Code, length) );
}

void RCSwitchLite::send(char* sCodeWord) {
  for (int nRepeat=0; nRepeat<nRepeatTransmit; nRepeat++) {
    int i = 0;
    while (sCodeWord[i] != '\0') {
      switch(sCodeWord[i]) {
...
void RCSwitchLite::transmit(int nHighPulses, int nLowPulses) {
//     #if not defined ( RCSwitchDisableReceiving )
...
/**
  ...
  */
char* RCSwitchLite::dec2binWzerofill(unsigned long Dec, unsigned int bitLength){
    return dec2binWcharfill(Dec, bitLength, '0');
}

char* RCSwitchLite::dec2binWcharfill(unsigned long Dec, unsigned int bitLength, char fill){
  static char bin[64];
  unsigned int i=0;
